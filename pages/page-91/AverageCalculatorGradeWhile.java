...
// ============================================================
// Page 91: Page 66의 if-else 조건문 로직 + While 반복문 결합
// ============================================================
// 학습 목표:
// 1. Page 66에서 배운 if-else 조건문으로 학점 판단 (calculateGrade 메서드)
// 2. While 반복문으로 여러 과목의 점수를 입력받아 평균 계산
// 3. 수동 카운터 제어 (i++ 직접 작성)의 중요성 이해
// ============================================================

// AverageCalculatorGradeWhile 클래스 정의: while 반복문으로 학점 계산
public class AverageCalculatorGradeWhile {
    ...
    public static void main(String[] args) {
        ...
        int total = 0;
        // i 변수 선언 및 초기화: while 반복문의 카운터 (초기값 0)
        int i = 0;
        
        // while 반복문: i가 count보다 작은 동안 계속 반복
        ...
        while (i < count) {
            ...
            total += score;
            // i++는 i = i + 1과 동일: 카운터를 1 증가시켜 다음 반복으로 이동
            // 이것이 없으면 무한 반복에 빠짐
            i++;
        }
